...
export default function Modal ({children, isOpen, handleClose}: ModalProps) {
  ...
  return (
    <ReactPortal wrapperId="react-portal-modal-container">
      {/*Overlay*/}
      <div className="fixed top-0 left-0 w-screen h-screen z-50 bg-neutral-800 opacity-50"/>
      
      <div className="fixed rounded flex flex-col box-border min-w-fit overflow-y-scroll overflow-x-hidden inset-y-0 inset-x-0 z-50" tabIndex={0}>
